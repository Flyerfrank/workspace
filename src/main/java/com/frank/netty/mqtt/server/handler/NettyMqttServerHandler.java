...
public class NettyMqttServerHandler extends SimpleChannelInboundHandler<MqttMessage> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, MqttMessage msg) {
        switch (msg.fixedHeader().messageType()){
            case CONNECT:
                System.out.println("我是：CONNECT");
                mqttHandlerService.doConnectMessage(ctx, (MqttConnectMessage)msg);
                break;
            case PUBLISH:
                System.out.println("我是：PUBLISH");
                mqttHandlerService.doPublishMessage(ctx, (MqttPublishMessage)msg);
                break;
            case SUBSCRIBE:
                System.out.println("我是：SUBSCRIBE");
                mqttHandlerService.doSubMessage(ctx, (MqttSubscribeMessage)msg);
                break;
            case PINGREQ:
                System.out.println("我是：PINGREQ");
                mqttHandlerService.doPingreoMessage(ctx, msg);
                break;
            case PUBACK:
                System.out.println("我是：PUBACK");
//                mqttHandlerService.doPubAck(ctx, msg);
            ...
            case UNSUBACK:
                ...
                break;
            case PINGRESP:
                mqttHandlerService.doPingrespMessage(ctx, msg);
                System.out.println("我是：PINGRESP");
                break;
            case DISCONNECT:
                System.out.println("我是：DISCONNECT");
                ctx.close();
                break;
            default:
                break;
...
//    private void doPingreoMessage(ChannelHandlerContext ctx, MqttMessage msg) {
...
//
//
//    private void doPingrespMessage(ChannelHandlerContext ctx, MqttMessage msg) {
//
//    }
//
//    /**
...
//     */
//    private void doSubMessage(ChannelHandlerContext ctx, MqttSubscribeMessage mqttSubscribeMessage) {
//
...
//     * @param msg
//     */
//    private void doConnectMessage(ChannelHandlerContext ctx, MqttConnectMessage msg){
//
//        // 消息解码器出现异常
...
//
//    /**
//     * 收到 MqttPublishMessage
//     * @param ctx
//     * @param msg
//     */
//    private void doPublishMessage(ChannelHandlerContext ctx, MqttPublishMessage msg) {
